...
//        rr.initialize(new FileSplit(new File("/Users/thucnt/Downloads/dl4j-examples/dl4j-examples/src/main/resources/classification/linear_data_train.csv")));
//        rr.reset();
...
//        rrTest.initialize(new FileSplit(new File("/Users/thucnt/Downloads/dl4j-examples/dl4j-examples/src/main/resources/classification/linear_data_eval.csv")));
//        rrTest.reset();
//        int nTestPoints = 500;
