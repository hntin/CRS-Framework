...
public class ExcelTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Sheet sheet2 = wb.createSheet("Chia Target - Dữ liệu nhập");
        ...
        XSSFCellStyle style = formatCell(wb, false, HorizontalAlignment.CENTER, "Arial", HSSFFont.BOLDWEIGHT_BOLD, (short) 24, HSSFColor.RED.index);
        ...
        style = formatCell(wb, false, HorizontalAlignment.CENTER, "Arial", HSSFFont.BOLDWEIGHT_BOLD, (short) 10, HSSFColor.BLACK.index);
        ...
        style = fillCellWithPattern(wb, false, FillPatternType.SOLID_FOREGROUND, IndexedColors.RED.getIndex(),
                HorizontalAlignment.CENTER, "Arial", HSSFFont.BOLDWEIGHT_BOLD, (short) 10, HSSFColor.BLACK.index);
        cell.setCellStyle(style);

        colIdx = 10;
        cell = sheet1.getRow(rowIdx).createCell(colIdx);
        style = formatCell(wb, false, HorizontalAlignment.LEFT, "Arial", HSSFFont.BOLDWEIGHT_BOLD, (short) 10, HSSFColor.BLACK.index);
        cell.setCellStyle(style);
        ...
        style = formatCell(wb, false, HorizontalAlignment.GENERAL, "Arial", HSSFFont.BOLDWEIGHT_BOLD, (short) 10, HSSFColor.BLACK.index);
        cell.setCellStyle(style);
        cell.setCellValue("ADMIN GIAO");

        // Row 4
        row = sheet1.createRow(++rowIdx);
        style = fillCellWithPattern(wb, true, FillPatternType.SOLID_FOREGROUND, IndexedColors.BLUE_GREY.getIndex(),
        ...
        // Row 5 
        row = sheet1.createRow(++rowIdx);
        style = formatCell(wb, true, HorizontalAlignment.LEFT, "Arial", HSSFFont.COLOR_NORMAL, (short) 10, HSSFColor.BLACK.index);
        for (colIdx = 0; colIdx <= 2; colIdx++) {
            cell = sheet1.getRow(rowIdx).createCell(colIdx);
            cell.setCellStyle(style);
            if (colIdx == 2) {
        ...
        style = formatCell(wb, true, HorizontalAlignment.RIGHT, "Arial", HSSFFont.COLOR_NORMAL, (short) 10, HSSFColor.BLACK.index);
        colIdx = 3;
        for (String s : trialList.keySet()) {
            cell = sheet1.getRow(rowIdx).createCell(colIdx);
            cell.setCellStyle(style);
        ...
        // Row 8
        row = sheet1.createRow(++rowIdx);
        style = fillCellWithPattern(wb, true, FillPatternType.SOLID_FOREGROUND, IndexedColors.BLUE_GREY.getIndex(), HorizontalAlignment.CENTER,
        ...
        for (TargetVersionDetailVO detail : listTargetVersionDetailVO) {
            ...
            for (colIdx = 0; colIdx <= 2; colIdx++) {
                cell = sheet1.getRow(rowIdx).createCell(colIdx);
                if (colIdx == 0) {
                    style = formatCell(wb, true, HorizontalAlignment.CENTER, "Arial", HSSFFont.COLOR_NORMAL, (short) 10, HSSFColor.BLACK.index);
                    cell.setCellStyle(style);
            ...
            for (int i=0; i< weekList.size(); i++) {
                for (String trial : trialList.keySet()) {
                    cell = sheet1.getRow(rowIdx).createCell(colIdx);
                    style = fillCellWithPattern(wb, true, FillPatternType.SOLID_FOREGROUND, IndexedColors.RED.getIndex(),
            ...
            for (String trial : trialList.keySet()) {
                cell = sheet1.getRow(rowIdx).createCell(colIdx);
                style = fillCellWithPattern(wb, true, FillPatternType.SOLID_FOREGROUND, IndexedColors.ORANGE.getIndex(),
                        HorizontalAlignment.RIGHT, "Arial", HSSFFont.COLOR_NORMAL, (short) 10, HSSFColor.WHITE.index);
                cell.setCellStyle(style);
                cell.setCellValue(trial);
                colIdx++;
        ...
        for (colIdx = 0; colIdx <= 2; colIdx++) {
            cell = sheet1.getRow(rowIdx).createCell(colIdx);
            style = fillCellWithPattern(wb, true, FillPatternType.SOLID_FOREGROUND, IndexedColors.YELLOW.getIndex(),
        ...
        // Dong "CL Chia"
        row = sheet1.createRow(++rowIdx);
        style = formatCell(wb, true, HorizontalAlignment.LEFT, "Arial", HSSFFont.BOLDWEIGHT_NORMAL, (short) 10, HSSFColor.BLACK.index);
        for (colIdx = 0; colIdx <= 2; colIdx++) {
            cell = sheet1.getRow(rowIdx).createCell(colIdx);
            cell.setCellStyle(style);
            if (colIdx == 2) {
        ...
        style = formatCell(wb, true, HorizontalAlignment.RIGHT, "Arial", HSSFFont.BOLDWEIGHT_NORMAL, (short) 10, HSSFColor.BLACK.index);
        colIdx = 3;
        for (String s : trialList.keySet()) {
            cell = sheet1.getRow(rowIdx).createCell(colIdx);
            cell.setCellStyle(style);
    ...
    private static XSSFCellStyle formatCell(SXSSFWorkbook wb, boolean isBolder, HorizontalAlignment alignment, String fontName, short fontBold, short fontSize, short fontColor) {
    ...
    private static XSSFCellStyle fillCellWithPattern(SXSSFWorkbook wb, boolean isBolder, FillPatternType fillPattern, short fillColor, HorizontalAlignment alignment,
